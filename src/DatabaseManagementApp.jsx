...
import {Database, Play, Table, RefreshCcw, Users, Building, Settings} from 'lucide-react';
...
const DatabaseManagementApp = () => {
    ...
    // Add this new render function for the user sync panel
    const renderUserSyncPanel = () => (
        <div className="mb-6 bg-white rounded-xl shadow-md border border-gray-200 p-4">
            <h3 className="text-lg font-semibold mb-4">User Sync Operations</h3>
            ...
            <div className="space-y-4">
                ...
                {/* Sync Logs */}
                {userSyncState.batchNo && (
                    <div className="mt-4">
                        <h4 className="font-medium mb-2">Sync Logs (Batch: {userSyncState.batchNo})</h4>
                        <div className="max-h-60 overflow-auto">
                            <pre className="text-sm bg-gray-50 p-3 rounded">
                                {JSON.stringify(userSyncState.logs, null, 2)}
                            </pre>
                        </div>
                    </div>
                )}
    ...
    // Add WeComSync panel render function
    const renderWecomSyncPanel = () => (
        <div className="mb-6 bg-white rounded-xl shadow-md border border-gray-200 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                    <h4 className="font-medium text-gray-700">Sync Operations</h4>
                ...
                <div className="space-y-2">
                    <h4 className="font-medium text-gray-700">Department Operations</h4>
                ...
                <div className="space-y-2 col-span-full">
                    <h4 className="font-medium text-gray-700">SQL Execution</h4>
                    <div className="flex gap-2">
                        <textarea id="adminSql" placeholder="Enter SQL"
                                  className="flex-1 px-3 py-2 border rounded h-20"/>
                        <button onClick={() => {
                            const sql = document.getElementById('adminSql').value;
                            handleWecomAction(`/admin/us/execute_sql?sql=${encodeURIComponent(sql)}`, 'PUT');
